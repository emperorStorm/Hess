...
+ (NSDictionary *)dictionaryForXMLParse:(NSXMLParser *)parser options:(XMLReaderOptions)options error:(NSError *__autoreleasing *)error
{
    XMLReader *reader = [[XMLReader alloc] initWithError:error];
    NSDictionary *rootDictionary = [reader objectWithXMLParser:parser options:options];
    return rootDictionary;
}
...
- (NSDictionary *)objectWithXMLParser:(NSXMLParser *)parser options:(XMLReaderOptions)options
{
